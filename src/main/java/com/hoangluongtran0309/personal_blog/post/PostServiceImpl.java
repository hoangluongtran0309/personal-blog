...
import com.hoangluongtran0309.personal_blog.post.web.PostNotFoundException;
...
public class PostServiceImpl implements PostService {
    ...
    public Post createPost(CreatePostParameters parameters) {
        ...
        Post post = new Post(id, parameters.getPostTitle(), parameters.getPostSummary(), parameters.getPostContent(), parameters.getPostStatus(), parameters.getPublishDate());
    ...
    public Page<Post> getAllPublishedPosts(Pageable pageable) {
        return postRepository.findByPostStatus(PostStatus.PUBLISHED, pageable);
    }
